...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    for (auto& light : lights)
    {
        ...
        auto diffuse = kd.cwiseProduct((light.intensity / distance_square)) * std::fmax(0.f, n.dot(light_direction));
        ...
        auto specular = ks.cwiseProduct((light.intensity / distance_square)) * pow(std::fmax(0.f, n.dot(h)), p);
...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "C:/Users/Zohar/Desktop/Games101作业/Assignment3/Code/models/spot/";

    // Load .obj File
    //读取文件之后将数据存入  渲染管线中的应用阶段
    bool loadout = Loader.LoadFile("C:/Users/Zohar/Desktop/Games101作业/Assignment3/Code/models/spot/spot_triangulated_good.obj");
